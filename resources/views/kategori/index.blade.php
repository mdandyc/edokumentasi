...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
			...
			<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <ul class="bt-list">
					  <li>
					  <a href="/kategori/create" class="hvr-icon-down col-10">Input</a>
					  </li>
					  </ul>
					    <table id="table">
						<thead>
		...
		<li><a href="/kategori/{{$data->id}}/edit" class="hvr-icon-up col-7">Edit</a></li>
										
										<li><a href="#" class="hvr-icon-shrink col-5" onclick="event.preventDefault();
                                                     document.getElementById('delete-form').submit(); if(!confirm('Are you sure want to delete this?')){return false;}" >Delete</a><form action="/kategori/{{$data->id}}" method="POST" id="delete-form" style="display:none;">
			...
			<input type="hidden" name="_method" value="DELETE">
					  ...
					  <center>
      {{$kategori->appends(Request::only('keyword'))->links()}}
      </center>
					</div>
